...
static void bench_vec3_mul_comp(void)
{
	...
	printf("vec3_mul_comp: %d ops in %.3f s -> %.1f Mops/s\n",
		   TEST_ITERATIONS, sec, TEST_ITERATIONS / sec / 1e6);
	(void)result;
}

static void bench_vec3_div_comp(void)
{
	volatile t_vec3 result;
	t_vec3 a = vec3_new(1.0f, 2.0f, 3.0f);
	t_vec3 b = vec3_new(4.0f, 5.0f, 6.0f);
	...
	double sec = time_diff_sec(t1, t2);
	printf("vec3_div_comp: %d ops in %.3f s -> %.1f Mops/s\n",
		   TEST_ITERATIONS, sec, TEST_ITERATIONS / sec / 1e6);
	(void)result;
}

static void bench_vec3_min_comp(void)
{
	volatile t_vec3 result;
	t_vec3 a = vec3_new(1.0f, 5.0f, 3.0f);
	t_vec3 b = vec3_new(4.0f, 2.0f, 6.0f);
	...
	double sec = time_diff_sec(t1, t2);
	printf("vec3_min_comp: %d ops in %.3f s -> %.1f Mops/s\n",
		   TEST_ITERATIONS, sec, TEST_ITERATIONS / sec / 1e6);
	(void)result;
}

static void bench_vec3_max_comp(void)
{
	volatile t_vec3 result;
	t_vec3 a = vec3_new(1.0f, 5.0f, 3.0f);
	t_vec3 b = vec3_new(4.0f, 2.0f, 6.0f);
	...
	double sec = time_diff_sec(t1, t2);
	printf("vec3_max_comp: %d ops in %.3f s -> %.1f Mops/s\n",
		   TEST_ITERATIONS, sec, TEST_ITERATIONS / sec / 1e6);
	(void)result;
}

static void bench_comp_mixed(void)
{
	volatile t_vec3 result;
	t_vec3 a = vec3_new(1.0f, 2.0f, 3.0f);
	t_vec3 b = vec3_new(4.0f, 5.0f, 6.0f);
	...
	double sec = time_diff_sec(t1, t2);
	printf("mixed comp: %d ops in %.3f s -> %.1f Mops/s\n",
		   TEST_ITERATIONS, sec, TEST_ITERATIONS / sec / 1e6);
	(void)result;
}
...
{
#ifdef BENCHMARK
    printf("\n=== Running benchmarks (component-wise) ===\n");
	bench_vec3_mul_comp();
	bench_vec3_div_comp();
	bench_vec3_min_comp();
	bench_vec3_max_comp();
