...
static void bench_vec3_length(void)
{
	...
	printf("vec3_length: %d ops in %.3f s -> %.1f Mops/s\n",
		   TEST_ITERATIONS, sec, TEST_ITERATIONS / sec / 1e6);
	(void)result;
}

static void bench_vec3_length_sq(void)
{
	volatile float result;
	t_vec3 v = vec3_new(1.0f, 2.0f, 3.0f);
	...
	double sec = time_diff_sec(t1, t2);
	printf("vec3_length_sq: %d ops in %.3f s -> %.1f Mops/s\n",
		   TEST_ITERATIONS, sec, TEST_ITERATIONS / sec / 1e6);
	(void)result;
}

static void bench_vec3_min(void)
{
	volatile float result;
	t_vec3 v = vec3_new(1.0f, 2.0f, 3.0f);
	...
	double sec = time_diff_sec(t1, t2);
	printf("vec3_min: %d ops in %.3f s -> %.1f Mops/s\n",
		   TEST_ITERATIONS, sec, TEST_ITERATIONS / sec / 1e6);
	(void)result;
}

static void bench_vec3_max(void)
{
	volatile float result;
	t_vec3 v = vec3_new(1.0f, 2.0f, 3.0f);
	...
	double sec = time_diff_sec(t1, t2);
	printf("vec3_max: %d ops in %.3f s -> %.1f Mops/s\n",
		   TEST_ITERATIONS, sec, TEST_ITERATIONS / sec / 1e6);
	(void)result;
}

static void bench_length_mixed(void)
{
	volatile float result;
	t_vec3 v = vec3_new(1.0f, 2.0f, 3.0f);
	...
	double sec = time_diff_sec(t1, t2);
	printf("mixed length: %d ops in %.3f s -> %.1f Mops/s\n",
		   TEST_ITERATIONS, sec, TEST_ITERATIONS / sec / 1e6);
	(void)result;
}
...
{
#ifdef BENCHMARK
    printf("\n=== Running benchmarks (length/minmax) ===\n");
	bench_vec3_length();
	bench_vec3_length_sq();
	bench_vec3_min();
	bench_vec3_max();
	bench_length_mixed();
#else
