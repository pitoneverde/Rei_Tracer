...
/*                                                    +:+ +:+         +:+     */
/*   By: gmu <gmu@student.42firenze.it>             +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/17 22:23:15 by gmu               #+#    #+#             */
/*   Updated: 2025/02/17 22:24:51 by gmu              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static int	ft_format_hex(char *nmbstr, int n, int is_up, t_format flags)
{
	int	count;
